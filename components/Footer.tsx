...
export function Footer() {
  return (
    <footer className="bg-[#1a1a1a] text-white relative overflow-hidden">
      {/* house */}
      <div className="absolute h-full w-full right-0 bottom-0 bg-[url('/images/home.png')] bg-cover"></div>
          ...
          <div className="space-y-8">
            <div>
              <p className="text-gray-300 text-base leading-relaxed max-w-lg font-light">
                ...
                functional spaces: from cozy homes to innovative designs, we
                bring your vision to life—one detail at a time. lets create
